(() => {
  ...
  function styles(){
    ...
    const s=document.createElement('style');s.id='sscp-runtime-style';s.textContent=`
      ...
      .sscp-card{background:#fff;border:1px solid var(--sline);border-radius:16px;overflow:hidden;box-shadow:0 8px 28px #15354d14}.sscp-qhead{padding:25px 32px;background:linear-gradient(130deg,var(--snavy),#0b5071);color:#fff}.sscp-meta{font-size:.77rem;opacity:.86;margin-bottom:12px}.sscp-question{font-size:1.15rem;line-height:1.85;font-weight:650}.sscp-body{padding:28px 32px}.sscp-options{display:grid;gap:12px}.sscp-option{display:grid;grid-template-columns:38px 1fr;align-items:center;width:100%;padding:13px;border:2px solid var(--sline);border-radius:11px;background:#fff;text-align:left;line-height:1.6;cursor:pointer}.sscp-option:hover:not(:disabled),.sscp-option.sel{border-color:var(--sblue);background:#edf7fa}.sscp-option.good{border-color:var(--sok);background:#edf8f3}.sscp-option.bad{border-color:var(--sbad);background:#fff0f2}.sscp-letter{display:grid;place-items:center;width:29px;height:29px;border-radius:50%;background:#e8eef2;color:var(--snavy);font-weight:800}.good .sscp-letter{background:var(--sok);color:#fff}.bad .sscp-letter{background:var(--sbad);color:#fff}.sscp-feedback{margin-top:20px;padding:18px;border-left:5px solid;border-radius:10px;line-height:1.75}.sscp-feedback.good{background:#edf8f3;border-color:var(--sok)}.sscp-feedback.bad{background:#fff0f2;border-color:var(--sbad)}
      ...
      @media(max-width:620px){.sscp-wrap{padding:8px}.sscp-qhead,.sscp-body{padding:18px 16px}.sscp-actions,.sscp-group{width:100%}.sscp-group .sscp-btn{flex:1}.sscp-question{font-size:1rem}}
